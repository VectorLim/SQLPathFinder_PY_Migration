...
""",
        ...
        crosstab={'row_keys': ['icmpcs', 'STARTTS', 'UTC', 'TZONE', 'SFOLDER', 'FAC', 'MARS', 'RIMS', 'EIMS', 'ARIES', 'OASYS', 'MONGO', 'MMS', 'MMSI', 'TOOLLOG', 'VFMARS', 'VFARIES', 'VFMONGO', 'CSRPATH', 'MMSPATH', 'MIPPATH', 'UNDERDEV', 'CSRV', 'MMSV'], 'header_key': 'parameter', 'value_key': 'value'},
    )
...
""",
        output='BIN4.csv',
        source_type='ARIES',
        crosstab={'row_keys': ['lot', 'operation', 'visual_id', 'test_end_date', 'tester_id', 'prodgroup3'], 'header_key': 'test_name', 'value_key': 'all_value'},
    )
