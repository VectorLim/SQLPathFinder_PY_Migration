...
# - step_0000_sql_query (Line 525): filters on f0.history_deleted_flag, f0.operation, f0.out_date, f0.owner, f4.history_deleted_flag, f4.unique_flag, f5.history_deleted_flag, f5.transaction, la.attribute_number, p.latest_version
# - step_0001_sql_query (Line 575): filters on bams0.lot, bams0.operation, yeuchuan_a1_17362.tab
# - step_0003_sqlite_query (Line 693): filters on FlagLot, a0.rowid, lot_1
