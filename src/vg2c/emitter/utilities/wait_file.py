"""WaitFile - poll for a file to appear within a timeout window."""
...
from vg2c.emitter.utilities._emit_helpers import split_utility_command, strip_quotes
