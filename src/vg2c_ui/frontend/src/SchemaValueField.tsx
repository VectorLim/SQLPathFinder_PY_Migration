...
function defaultValue(schema: ValueSchemaView): unknown {
  ...
  if (schema.kind === 'union') return schema.variants[0] ? defaultValue(schema.variants[0]) : null
