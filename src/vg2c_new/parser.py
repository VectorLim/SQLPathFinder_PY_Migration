...
_RESOLVER_MANIFEST_BASE += (
    ...
    ("HTML-RPLOT", "HTMLRPlotTask", "report.rplot", "AMENDED_PORT", "R", "report parity"),
    ("HTML-RPLOT-SHOW", "HTMLRPlotTask", "report.rplot_show", "AMENDED_PORT", "R", "report parity"),
    (
        "HTML-DELETE",
        "HTMLDeleteTask",
        "report.delete",
    ...
    ("HTML-JS-SHOW", "HTMLJSTask", "report.js_show", "REWRITE", "html/js", "report parity"),
    ("HTML-JS-DEFER", "HTMLJSTask", "report.js_defer", "REWRITE", "html/js", "report parity"),
